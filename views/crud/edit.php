		...
		<form method="POST" class="form-edit-data"  enctype="multipart/form-data">
			<input type="text" value="<?= $obj->id ?>" name="id" hidden>
			<!-- <div class="form-group">
				<label>Foto</label>
				<input type="file" class="form-control" name="foto" required="true" value="<?= $obj->foto ?>" multiple accept='image/*'>
			</div> -->
			<div class="form-group">
				<label>Nama</label>
				<input type="text" class="form-control" name="nama" required="true" value="<?= $obj->nama ?>">
			</div>
			<hr>
			<div class="form-group">
				<label>Tempat Lahir</label>
				<input type="text" class="form-control" name="tmpLahir" required="true" value="<?= $obj->tmpLahir ?>">
			</div>
			<hr>
			<div class="form-group">
				<label>Tanggal Lahir</label>
				<input type="date" class="form-control" name="tgLahir" required="true" value="<?= $obj->tgLahir ?>">
			</div>
			<hr>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<select class="form-control" name="goldar" required="true">
					<option value="<?= $obj->goldar ?>" selected><?= $obj->goldar ?></option>
			...
			<div class="form-group">
				<label>Alamat</label>
				<input type="text"  class="form-control" name="alamat" required="true" value="<?= $obj->alamat ?>">
			</div>
			<div class="form-group form-inline">
				<label>RT/RW</label>
				<input type="text"  class="form-control" name="rtrw" required="true" value="<?= $obj->rtrw ?>">
				<label>Kelurahan/Desa</label>
				<input type="text"  class="form-control" name="keldes" required="true" value="<?= $obj->keldes ?>">
				<label>Kecamatan</label>
				<input type="text"  class="form-control" name="kec" required="true" value="<?= $obj->kec ?>">
			</div>
			<hr>			
			<div class="form-group">
				<label>Agama</label>
				<select class="form-control" name="agama" required="true">
					<option value="<?= $obj->agama ?>" selected><?= $obj->agama ?></option>
			...
			<div class="form-group">
				...
				<select class="form-control" name="mariage" required="true">
					<option value="<?= $obj->mariage?>" selected><?= $obj->mariage ?></option>
			...
			<div class="form-group">
				...
				<input type="text"  class="form-control" name="nation" required="true" value="<?= $obj->nation?>">
			</div>
			<div class="form-group">
				<label>Berlaku Hingga</label>
				<input type="date"  class="form-control" name="exp" required="true" value="<?= $obj->exp ?>">
			</div>
